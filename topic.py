...
# 读取Excel文档
df = pd.read_excel('2015.xlsx', header=None)
...
for bow in corpus:
    ...
    topic_topic_dist = {topic_id: prob for topic_id, prob in topics}
    document_topic_matrix.append([topic_topic_dist.get(i, 0) for i in range(num_topics)])
...
with pd.ExcelWriter(output_path) as writer:
    ...
    document_topic_df.to_excel(writer, sheet_name='Document-Topics', index=False)
